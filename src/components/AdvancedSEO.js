...
const AdvancedSEO = ({
  ...
  const defaultDescription =
    "Premium shea butter products, African textiles, and business solutions. Discover La Veeda, AfriSmocks, and OgriBusiness brands. B2B trading platform for quality African products.";
  const defaultKeywords =
    "shea butter, African textiles, B2B trading, La Veeda, AfriSmocks, OgriBusiness, Ghana, African products, wholesale, business solutions, premium quality, natural skincare, traditional crafts";
  ...
  const seoCanonical = canonicalUrl
