...
export const generateProductSEO = (product) => {
  ...
  return {
    title: `${product.name} - Premium ${
      product.brandName || "African"
    } Product`,
    description:
      product.shortDescription ||
      product.description ||
      `Discover ${product.name}, a premium quality product from ${
        product.brandName || "our collection"
      }. Natural, authentic, and sustainably sourced.`,
...
export const generateBrandSEO = (brand) => {
  ...
  const brandDescriptions = {
    "la-veeda":
      "Premium Quality Shea Butter, African Black Soap, and Natural Skincare Products. Sustainably sourced and traditionally handcrafted.",
    afrismocks:
      "Authentic African smocks, traditional kente cloth, and contemporary African fashion pieces. Celebrating Ghanaian heritage.",
    ogribusiness:
      "Innovative business solutions and agricultural products. Supporting local communities with sustainable practices.",
  };
  ...
  return {
    ...
    description:
      ...
      brand.description ||
      `Discover ${brand.name}, premium quality products from Ghana. Authentic, natural, and sustainably sourced.`,
...
export const generateStorySEO = (story) => {
  ...
  return {
    ...
    description:
      ...
      `Read about ${story.title} and discover our commitment to quality and community.`,
...
export const generateLocalBusinessStructuredData = () => {
  return {
    ...
    name: "Ogla Shea Butter & General Trading",
    description:
      "Premium shea butter products, African textiles, and business solutions from Ghana",
