...
// TinyMCE handles content sanitization automatically
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="mt-1">
                  <Editor
                    apiKey="w76n38i03crugrfwkircujxuf7qdpeglvlli6kkvduibds4g"
                    ...
                    init={{
                      ...
                      plugins: [
                        ...
                        // Premium features (available until Sep 15, 2025)
                      ...
                      uploadcare_public_key: '44a3e7133d4777482bf6',
                      // Enhanced table options
                      table_toolbar: 'tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol',
                      // Better image handling
                      image_upload_handler: (blobInfo, success, failure) => {
                        // You can implement custom image upload here if needed
                        success('data:' + blobInfo.blob().type + ';base64,' + blobInfo.base64());
                      },
                      // Accessibility improvements
                      a11y_advanced_options: true,
                      // Better typography
                      typography_default_lang: 'en',
                      typography_endashes: true,
                      typography_hanging_punctuation: true,
                      typography_smart_quotes: true,
                      typography_smart_spacing: true,
                      typography_smart_ellipses: true
                    }}
                  />
                </div>
